                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: Opacity(
                              // Completed task lebih transparan
                              opacity: task.isCompleted ? 0.7 : 1.0,
                              // ListTile dengan design yang lebih baik
                              child: ListTile(
                                // Leading: container custom untuk nomor urut atau checkmark
                                leading: Container(
                                  width: 40,
                                  height: 40,
                                  // Dekorasi: background berbeda berdasarkan status
                                  decoration: BoxDecoration(
                                    color: task.isCompleted ? Colors.green[100] : Colors.blue[100],
                                    shape: BoxShape.circle,
                                  ),
                                  // Center nomor urut atau checkmark di tengah container
                                  child: Center(
                                ...
                                // Title dengan styling yang berubah berdasarkan status
                                title: Text(
                                ...
                                // Subtitle dengan info tambahan berdasarkan status
                                subtitle: Text(
